  ...
  onUpdate() {
    ...
    axios
      ...
      .then((response) => {
        ...
        this.props.actions.updateAttendee({
          event: this.props.navigation.state.params.id,
          attendee: this.props.navigation.state.params.attendee,
          attendeeIndex: this.props.navigation.state.params.attendeeIndex,
      ...
      [
        { text: 'No', onPress: () => {}, style: 'cancel' },
        {
          ...
          onPress: () => {
            ...
            axios
              .delete(API_BASE_URL.attendee + '/' + this.props.attendee._id, {
                params: { token: this.props.token },
              })
              .then((response) => {
                console.log('delete_attendee response = ', response);
                this.setState({ isDeleting: false });
                this.props.actions.removeAttendee({
                  event: this.props.navigation.state.params.id,
                  attendee: this.props.navigation.state.params.attendee,
                  attendeeIndex: this.props.navigation.state.params
                    .attendeeIndex,
                });
                this.props.navigation.dispatch(NavigationActions.back());
              })
...
const mapStateToProps = (state, props) => ({
  ...
  attendee:
    state.attendee.eventAttendees[props.navigation.state.params.id][
      props.navigation.state.params.attendee
    ] || {},
});
