...
export default function settings(state = initialState, action) {
  switch (action.type) {
    case types.ADD_CERT_RECEIVER:
      const newCertList = state.certReceivers.slice(0);
    ...
    case types.REMOVE_CERT_RECEIVER:
      const newCertList1 = state.certReceivers.slice(0);
    ...
    case types.ADD_SHEET_RECEIVER:
      const newSheetList = state.sheetReceivers.slice(0);
    ...
    case types.REMOVE_SHEET_RECEIVER:
      const newSheetList1 = state.sheetReceivers.slice(0);
